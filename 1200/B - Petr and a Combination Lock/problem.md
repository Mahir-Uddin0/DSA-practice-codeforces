...
Petr called his car dealer, who instructed him to rotate the lock's wheel exactly n times. The i-th rotation should be aᵢ degrees, either clockwise or counterclockwise, and after all n rotations the pointer should again point at zero.
...
Each of the following n lines contains one integer aᵢ (1 ≤ aᵢ ≤ 180) — the angle of the i-th rotation in degrees.
...
[View the original problem on Codeforces](https://codeforces.com/contest/1097/problem/B)
